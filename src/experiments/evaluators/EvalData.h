...
class EvalData {
    ...
    // [fitness, mean teams per prediction, mean instructions per prediction, mean flops per prediction]
    ...
    // Number of flops per prediction (overwritten for each prediction)
    size_t flop_count;
