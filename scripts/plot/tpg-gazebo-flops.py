...
phase = 0
task_set = "_0_"
col_to_plot = "flop_complexity_task_0"   # FLOPs column
min_gen_cutoff = 50
...
if __name__ == "__main__":
    ...
    pdf_path = os.path.join(out_dir, "stateful_vs_stateless_mean_flops.pdf")
    png_path = os.path.join(out_dir, "stateful_vs_stateless_mean_flops.png")
