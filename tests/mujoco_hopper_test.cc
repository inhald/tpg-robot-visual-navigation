...
#include "../src/environments/mujoco/MuJoco_Hopper.h"
#include <random>
#include <TPG.h>
...
TEST_CASE("MuJoco_Hopper Initialization", "[init]") {
    std::unordered_map<std::string, std::any> params = createDefaultParams();
    INFO("Initializing Environment");
    MuJoco_Hopper hopper(params);
...
TEST_CASE("MuJoco_Hopper Terminal Condition", "[terminal]") {
    std::unordered_map<std::string, std::any> params = createDefaultParams();
    MuJoco_Hopper hopper(params);
...
TEST_CASE("MuJoco_Hopper Healthy Reward", "[healthy_reward]") {
    std::unordered_map<std::string, std::any> params = createDefaultParams();
    MuJoco_Hopper hopper(params);
...
TEST_CASE("MuJoco_Hopper Control Cost", "[control_cost]") {
    std::unordered_map<std::string, std::any> params = createDefaultParams();
    MuJoco_Hopper hopper(params);
...
TEST_CASE("MuJoco_Hopper Is Healthy", "[is_healthy]") {
    std::unordered_map<std::string, std::any> params = createDefaultParams();
    MuJoco_Hopper hopper(params);
...
TEST_CASE("MuJoco_Hopper Simulation Step", "[sim_step]") {
    std::unordered_map<std::string, std::any> params = createDefaultParams();
    MuJoco_Hopper hopper(params);
...
TEST_CASE("MuJoco_Hopper Get Observation", "[get_obs]") {
    std::unordered_map<std::string, std::any> params = createDefaultParams();
    MuJoco_Hopper hopper(params);
...
// TEST_CASE("MuJoco_Hopper Reset Function", "[reset]") {
//     std::unordered_map<std::string, std::any> params = createDefaultParams();
//     MuJoco_Hopper hopper(params);
