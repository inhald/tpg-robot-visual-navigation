...
#include "../src/environments/mujoco/MuJoco_Inverted_Pendulum.h"
#include <random>
#include <TPG.h>
...
TEST_CASE("MuJoco_Inverted_Pendulum Initialization", "[init]") {
    std::unordered_map<string, std::any> params = createDefaultParams();    
    INFO("Initializing Environment");
    MuJoco_Inverted_Pendulum pendulum(params);
...
TEST_CASE("MuJoco_Inverted_Pendulum Terminal Condition", "[terminal]") {
    std::unordered_map<string, std::any> params = createDefaultParams();
    INFO("Initializing Environment");
    MuJoco_Inverted_Pendulum pendulum(params);
...
TEST_CASE("MuJoco_Inverted_Pendulum Simulation Step", "[sim_step]") {
    std::unordered_map<string, std::any> params = createDefaultParams();
...
TEST_CASE("MuJoco_Inverted_Pendulum Get Observation", "[get_obs]") {
...
// TEST_CASE("MuJoco_Inverted_Pendulum Reset Function", "[reset]") {
//     std::unordered_map<string, std::any> params = createDefaultParams();
