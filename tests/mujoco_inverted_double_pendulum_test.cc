...
#include "../src/environments/mujoco/MuJoco_Inverted_Double_Pendulum.h"
#include <random>
#include <TPG.h>
...
TEST_CASE("MuJoco_Inverted_Double_Pendulum Initialization", "[init]") {
    std::unordered_map<std::string, std::any> params = createDefaultParams();
    INFO("Initializing Environment");
    MuJoco_Inverted_Double_Pendulum pendulum(params);
...
TEST_CASE("MuJoco_Inverted_Double_Pendulum Terminal Condition", "[terminal]") {
    std::unordered_map<std::string, std::any> params = createDefaultParams();
    MuJoco_Inverted_Double_Pendulum pendulum(params);
...
TEST_CASE("MuJoco_Inverted_Double_Pendulum Simulation Step", "[sim_step]") {
    std::unordered_map<std::string, std::any> params = createDefaultParams();
    MuJoco_Inverted_Double_Pendulum pendulum(params);
...
TEST_CASE("MuJoco_Inverted_Double_Pendulum Get Observation", "[get_obs]") {
    std::unordered_map<std::string, std::any> params = createDefaultParams();
    MuJoco_Inverted_Double_Pendulum pendulum(params);
...
// TEST_CASE("MuJoco_Inverted_Double_Pendulum Reset Function", "[reset]") {
//     std::unordered_map<std::string, std::any> params = createDefaultParams();
//     MuJoco_Inverted_Double_Pendulum pendulum(params);
