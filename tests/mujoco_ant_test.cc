...
#include "../src/environments/mujoco/MuJoco_Ant.h"
#include <random>
#include <TPG.h>
...
std::unordered_map<std::string, std::any> createDefaultParams() {
    ...
    params["mj_healthy_reward"] = 1.0;
    params["mj_terminate_when_off_course"] = 0;
    params["mj_ant_exclude_position_from_observation"] = 1;
    return params;
}

TEST_CASE("MuJoco_Ant Initialization", "[init]") {
    std::unordered_map<std::string, std::any> params = createDefaultParams();
    INFO("Initializing Environment");
    MuJoco_Ant ant(params);
...
TEST_CASE("MuJoco_Ant Terminal Condition", "[terminal]") {
    std::unordered_map<std::string, std::any> params = createDefaultParams();
    MuJoco_Ant ant(params);
...
TEST_CASE("MuJoco_Ant Healthy Reward", "[healthy_reward]") {
    std::unordered_map<std::string, std::any> params = createDefaultParams();
    MuJoco_Ant ant(params);
...
TEST_CASE("MuJoco_Ant Control Cost", "[control_cost]") {
    std::unordered_map<std::string, std::any> params = createDefaultParams();
    MuJoco_Ant ant(params);
...
TEST_CASE("MuJoco_Ant Contact Cost", "[contact_cost]") {
    std::unordered_map<std::string, std::any> params = createDefaultParams();
    MuJoco_Ant ant(params);
...
TEST_CASE("MuJoco_Ant Is Healthy", "[is_healthy]") {
    std::unordered_map<std::string, std::any> params = createDefaultParams();
    MuJoco_Ant ant(params);
...
TEST_CASE("MuJoco_Ant Simulation Step", "[sim_step]") {
    std::unordered_map<std::string, std::any> params = createDefaultParams();
    MuJoco_Ant ant(params);
...
TEST_CASE("MuJoco_Ant Get Observation", "[get_obs]") {
    std::unordered_map<std::string, std::any> params = createDefaultParams();
    MuJoco_Ant ant(params);
...
// TEST_CASE("MuJoco_Ant Reset Function", "[reset]") {
//     std::unordered_map<std::string, std::any> params = createDefaultParams();
//     MuJoco_Ant ant(params);
