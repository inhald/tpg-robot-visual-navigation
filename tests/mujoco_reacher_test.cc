...
#include "../src/environments/mujoco/MuJoco_Reacher.h"
#include <random>
#include <TPG.h>
...
TEST_CASE("MuJoco_Reacher Initialization", "[init]") {
    std::unordered_map<std::string, std::any> params = createDefaultParams();
    INFO("Initializing Environment");
    MuJoco_Reacher reacher(params);
...
TEST_CASE("MuJoco_Reacher Terminal Condition", "[terminal]") {
    std::unordered_map<std::string, std::any> params = createDefaultParams();
    MuJoco_Reacher reacher(params);
...
TEST_CASE("MuJoco_Reacher Control Cost", "[control_cost]") {
    std::unordered_map<std::string, std::any> params = createDefaultParams();
    MuJoco_Reacher reacher(params);
...
TEST_CASE("MuJoco_Reacher Get Distance", "[get_dist]") {
    std::unordered_map<std::string, std::any> params = createDefaultParams();
    MuJoco_Reacher reacher(params);
...
TEST_CASE("MuJoco_Reacher Simulation Step", "[sim_step]") {
    std::unordered_map<std::string, std::any> params = createDefaultParams();
    MuJoco_Reacher reacher(params);
...
TEST_CASE("MuJoco_Reacher Get Observation", "[get_obs]") {
    std::unordered_map<std::string, std::any> params = createDefaultParams();
    MuJoco_Reacher reacher(params);
...
// TEST_CASE("MuJoco_Reacher Reset Function", "[reset]") {
//     std::unordered_map<std::string, std::any> params = createDefaultParams();
//     MuJoco_Reacher reacher(params);
